        ...
        {activeTab === 'contracts' && (
          <div className="p-8 space-y-6 overflow-y-auto custom-scrollbar">
            <div className="flex justify-between items-center">
              ...
              <button className="px-4 py-2 bg-porteo-orange text-white rounded-xl text-xs font-bold flex items-center gap-2">
              ...
              {[
                ...
                <div key={i} className="p-6 bg-white/5 border border-white/10 rounded-[32px] space-y-4 hover:border-porteo-orange/30 transition-all">
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 py-2 bg-white/5 rounded-xl text-[10px] font-bold text-white hover:bg-white/10 transition-all">
        ...
        {activeTab === 'disputes' && (
          <div className="p-8 space-y-6 overflow-y-auto custom-scrollbar">
            <div className="flex justify-between items-center">
              ...
              <button className="px-4 py-2 bg-white/5 border border-white/10 text-white rounded-xl text-xs font-bold">
          ...
          <div className="p-8 space-y-6 overflow-y-auto custom-scrollbar">
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                <button className="px-4 py-2 bg-white/5 border border-white/10 text-white rounded-xl text-xs font-bold flex items-center gap-2">
              ...
              {billingRules.map((rule) => (
                <div key={rule.id} className="p-6 bg-white/5 border border-white/10 rounded-3xl space-y-4 hover:border-porteo-orange/30 transition-all">
                  ...
                  <div className="flex gap-2 pt-2">
                    <button className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-[10px] font-bold text-white hover:bg-white/10 transition-all">
        ...
        {activeTab === 'calculator' && (
          <div className="p-8 space-y-8 overflow-y-auto custom-scrollbar">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2 px-4 py-2 bg-porteo-orange/10 border border-porteo-orange/20 rounded-xl">
